...
<!-- Mirrored from coderthemes.com/ubold/layouts/light-horizontal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Apr 2019 22:52:01 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!-- Plugins css -->
    <link href="/one/libs/flatpickr/flatpickr.min.css" rel="stylesheet" type="text/css" />

    <!-- App css -->
    <link href="/one/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="/one/css/icons.min.css" rel="stylesheet" type="text/css" />
    <link href="/one/css/app.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="container-fluid">
            <ul class="list-unstyled topnav-menu float-right mb-0">
                        ...
                        <div class="slimscroll noti-scroll">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img src="/one/images/users/user-1.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="/one/images/users/user-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="/one/images/users/user-1.jpg" alt="user-image" class="rounded-circle">
            ...
            <div class="logo-box">
                <a href="index.html" class="logo text-center">
                            <span class="logo-lg">
                                <img src="/one/images/logo-dark.png" alt="" height="18">
                                <!-- <span class="logo-lg-text-light">UBold</span> -->
                            </span>
                    <span class="logo-sm">
                                <!-- <span class="logo-sm-text-dark">U</span> -->
                                <img src="/one/images/logo-sm.png" alt="" height="24">
                            </span>
                </a>
            </div>
...
<!-- Plugins js-->
<script src="/one/libs/flatpickr/flatpickr.min.js"></script>
<script src="/one/libs/jquery-knob/jquery.knob.min.js"></script>
<script src="/one/libs/jquery-sparkline/jquery.sparkline.min.js"></script>
<script src="/one/libs/flot-charts/jquery.flot.js"></script>
<script src="/one/libs/flot-charts/jquery.flot.resize.js"></script>
<script src="/one/libs/flot-charts/jquery.flot.time.js"></script>
<script src="/one/libs/flot-charts/jquery.flot.tooltip.min.js"></script>
<script src="/one/libs/flot-charts/jquery.flot.selection.js"></script>
<script src="/one/libs/flot-charts/jquery.flot.crosshair.js"></script>

<!-- Dashboar 1 init js-->
<script src="/one/js/pages/dashboard-1.init.js"></script>

<!-- App js-->
<script src="/one/js/app.min.js"></script>

</body>

<!-- Mirrored from coderthemes.com/ubold/layouts/light-horizontal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Apr 2019 22:54:22 GMT -->
</html>
