...
<head>
    ...
    <!-- Bootstrap -->
    <link href="/vendorwed/css/bootstrap.min.css" rel="stylesheet">
    {{--<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">--}}

    <!-- Template style.css -->
    <link rel="stylesheet" type="text/css" href="/vendorwed/css/style.css">
    <link rel="stylesheet" type="text/css" href="/vendorwed/css/owl.carousel.css">
    <link rel="stylesheet" type="text/css" href="/vendorwed/css/owl.theme.css">
    <link rel="stylesheet" type="text/css" href="/vendorwed/css/owl.transitions.css">
    ...
    <!-- favicon icon -->
    <link rel="shortcut icon" href="/vendorwed/images/favicon.ico" type="image/x-icon">
...
<div id="app">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 logo">
                    <div class="navbar-brand">
                        <a href="/"><img src="/vendorwed/images/logo.png" alt="Wedding Vendors" class="img-responsive"></a>
                    </div>
                </div>
    ...
    <div class="slider-bg">
        ...
        <div id="slider" class="owl-carousel owl-theme slider">
            <div class="item"><img src="/vendorwed/images/hero-image-3.jpg" alt="Wedding couple just married"></div>
            <div class="item"><img src="/vendorwed/images/hero-image-2.jpg" alt="Wedding couple just married"></div>
            <div class="item"><img src="/vendorwed/images/hero-image.jpg" alt="Wedding couple just married"></div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="feature-block feature-center">
                        <!-- feature block -->
                        <div class="feature-icon"><img src="/vendorwed/images/vendor.svg" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="feature-block feature-center">
                        <!-- feature block -->
                        <div class="feature-icon"><img src="/vendorwed/images/mail.svg" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="feature-block feature-center">
                        <!-- feature block -->
                        <div class="feature-icon"><img src="/vendorwed/images/couple.svg" alt=""></div>
            ...
            <div class="row ">
                <div class="col-md-4">
                    ...
                    <div class="vendor-box">
                        <div class="vendor-image">
                            <!-- vendor pic -->
                            <a href="#"><img src="/vendorwed/images/vendor-1.jpg" alt="wedding vendor" class="img-responsive"></a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="vendor-box">
                        <div class="vendor-image">
                            <!-- vendor pic -->
                            <a href="#"><img src="/vendorwed/images/vendor-4.jpg" alt="wedding vendor" class="img-responsive"></a>
                ...
                <div class="col-md-4 vendor-box">
                    ...
                    <div class="vendor-image">
                        <!-- vendor pic -->
                        <a href="#"><img src="/vendorwed/images/vendor-3.jpg" alt="wedding vendor" class="img-responsive"></a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="/vendorwed/images/location-pic.jpg" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">New York City</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="/vendorwed/images/location-pic-2.jpg" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Sydney</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="/vendorwed/images/location-pic-3.jpg" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Russia</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-8 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="/vendorwed/images/location-pic-4.jpg" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Germany</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="/vendorwed/images/location-pic-5.jpg" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Paris</span></a> </div>
                </div>
                <!-- /.location block -->
            </div>
        </div>
                ...
                <div class="col-md-12 tp-testimonial">
                    <div id="testimonial" class="owl-carousel owl-theme">
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="/vendorwed/images/couple.jpg" alt="" class="img-circle"></div>
                        ...
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="/vendorwed/images/couple-2.jpg" alt="" class="img-circle"></div>
                            <div class="feedback-caption">
                        ...
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="/vendorwed/images/couple-3.jpg" alt="" class="img-circle"></div>
                            <div class="feedback-caption">
                        ...
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="/vendorwed/images/couple-4.jpg" alt="" class="img-circle"></div>
                            <div class="feedback-caption">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 couple-block">
                    <div class="couple-icon"><img src="/vendorwed/images/couple.svg" alt=""></div>
                    <h2>Are you couple find the venue ?</h2>
                    <p>Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                    <a href="#" class="btn btn-primary">Find Vendor</a> </div>
                <div class="col-md-6 vendor-block">
                    <div class="vendor-icon"><img src="/vendorwed/images/vendor.svg" alt=""></div>
...
<script src="/vendorwed/js/jquery.min.js"></script>
{{--<!-- Include all compiled plugins (below), or include individual files as needed -->--}}
<script src="/vendorwed/js/bootstrap.min.js"></script>
...
{{--<!-- Flex Nav Script -->--}}
<script src="/vendorwed/js/jquery.flexnav.js" type="text/javascript"></script>
<script src="/vendorwed/js/navigation.js"></script>

<!-- Scripts -->

<!-- slider -->
<script src="/vendorwed/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="/vendorwed/js/slider.js"></script>
<!-- testimonial -->
<script type="text/javascript" src="/vendorwed/js/testimonial.js"></script>
<!-- sticky header -->
<script src="/vendorwed/js/jquery.sticky.js"></script>
<script src="/vendorwed/js/header-sticky.js"></script>


</body>


<!-- Mirrored from jituchauhan.com/wedding/wedding-new/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Apr 2019 15:38:23 GMT -->
</html>
